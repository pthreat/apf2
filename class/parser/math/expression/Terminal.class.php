<?php
	...
	namespace apf\parser\math\expression{
		...
		use apf\parser\math\operator\Addition;
		use apf\parser\math\operator\Multiplication;
		use apf\parser\math\operator\Division;
		use apf\parser\math\operator\Substraction;
