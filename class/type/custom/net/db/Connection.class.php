	...
	namespace apf\type\db{
		...
		class Connection extends \apf\type\net\Connection{
			...
			public function setId($id){
				...
				$id	=	ValidateString::mustBeNotEmpty($id,"Connection ID must be not empty");
			...
			public function setDriver($driver=NULL){
				...
				$driver	=	strtolower(ValidateString::mustBeNotEmpty($driver,"Driver name can't be empty"));
			...
			public function addSchema($name=NULL){
				...
				$this->schemas[]	=	ValidateString::mustBeNotEmpty($name,"Schema name can't be empty");
